...
describe('Korean fieldwork report handoff', () => {
    ...
    it('carries tablet investigation checklist steps into HWP copy blocks with Korean labels', () => {
        ...
        expect(featureItem?.copyText).not.toContain('stratigraphicBoundary');
        expect(featureItem?.copyText).not.toContain('photoAngleAndScale');
    ...
    it('uses tablet media metadata as direct HWP copy summaries', () => {
        ...
        const documents = [
            ...
            makeDocument('drawing-1', 'Drawing', {
                ...
                drawingSurveyStages: ['duringInvestigation'],
        ...
        expect(drawingItem?.summary)
            .toContain('\uc2e4\uce21 \ubc29\uc2dd: \uc190\uc2e4\uce21\u00b73D \uc2e4\uce21');
        expect(drawingItem?.copyText)
            .toContain('3D \uc7a5\ube44: DSLR\u00b7\ub4dc\ub860');
        expect(drawingItem?.copyText)
            .toContain('\uc2e4\uce21 \ub2e8\uacc4: \uc870\uc0ac \uc911');
