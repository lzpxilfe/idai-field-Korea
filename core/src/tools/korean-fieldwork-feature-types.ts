...
export const getKoreanFieldworkFeatureTypeOption = (
    ...
    typeof value === 'string'
        ? KOREAN_FIELDWORK_FEATURE_TYPE_OPTIONS.find(option => option.value === value)
        : undefined;
...
export const getKoreanFieldworkFeatureIdentifierPrefix = (
        value: unknown
): string =>
    getKoreanFieldworkFeatureTypeOption(value)?.identifierPrefix
    ?? getKoreanFieldworkFeatureTypeOption('unknown')!.identifierPrefix;
