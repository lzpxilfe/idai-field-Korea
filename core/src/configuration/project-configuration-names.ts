...
export const KOREAN_FIELDWORK_GEOMETRY_SOURCE_AERIAL_LAYER_TRACE = 'aerialLayerTrace';
...
export const KOREAN_FIELDWORK_REFERENCE_BASEMAP_PROVIDER_KAKAO_ROADMAP = 'kakaoRoadmap';
export const KOREAN_FIELDWORK_REFERENCE_BASEMAP_PROVIDER_KAKAO_SKYVIEW = 'kakaoSkyview';
export const KOREAN_FIELDWORK_REFERENCE_BASEMAP_PROVIDER_KAKAO_HYBRID = 'kakaoHybrid';
export const KOREAN_FIELDWORK_REFERENCE_BASEMAP_PROVIDER_PLAIN_CANVAS = 'plainCanvas';
