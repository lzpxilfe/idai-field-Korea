...
BridgeDesk 창을 HWP 옆에 띄워두고 필요한 내용을 바로 복사할 수 있습니다.

- `초안 복사`: 전체 보고서 초안 복사
- `표 복사`: 전체 기록을 HWP 표에 붙여넣기 쉬운 탭 구분 형식으로 복사
- `기록 복사`: 선택한 발굴 기록을 문단으로 복사
- `표 행 복사`: 선택한 발굴 기록을 표 한 줄로 복사

파일로 묶어서 전달해야 할 때는 아래 절차를 사용합니다.
