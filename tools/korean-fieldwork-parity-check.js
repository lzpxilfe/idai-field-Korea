...
function validateReportHandoffPreSaveValidation() {
  ...
  if (!coreReportHandoffText.includes('getSoilProfilePhotoEvidenceSummary')
    ...
    findings.push('report handoff HWP copy blocks must carry soil profile color swatches, tablet daily logs, tablet feature sketches, tablet photo/drawing annotations, and tablet eyedropper sample locations');
  }
