...
function validateRecordPanelOrder() {
  ...
  const desktopRecordTabletBundleText = readTextFile(
    'desktop/src/app/util/korean-fieldwork-record-tablet-bundle.ts'
  );
  const desktopRecordTabletBundleSpecText = readTextFile(
    'desktop/test/unit/util/korean-fieldwork-record-tablet-bundle.spec.ts'
  );
  ...
  if (!desktopRecordContextPanelText.includes('isEvidenceInsightApplied')
      || !desktopRecordContextPanelTemplateText.includes('korean-fieldwork-record-context-evidence-insight-applied')
      || !desktopRecordContextPanelStyleText.includes('korean-fieldwork-record-context-evidence-insight-applied')
  ...
  if (!desktopRecordTabletBundleText.includes('makeKoreanFieldworkEvidenceReview')
      ...
      || !desktopRecordTabletBundleText.includes('getKoreanFieldworkFindSpotSummaryText')
      || !desktopRecordTabletBundleText.includes('getKoreanFieldworkRecordFieldValueSummary')
      || !desktopRecordTabletBundleText.includes('getFindSpotDetail')
      || !desktopRecordTabletBundleText.includes('getFindSampleRecordDetail')
      || !desktopRecordTabletBundleText.includes('getPhotoAnnotationSummaryLabel')
      || !desktopRecordTabletBundleText.includes('getPenMemoSketchSummaryLabel')
      || !desktopRecordTabletBundleText.includes('getPenMemoTranscriptionSummaryLabel')
      || !desktopRecordTabletBundleText.includes('getDocumentFieldDetails')
      || !desktopRecordTabletBundleText.includes('getMediaSourceDetail')
      || !desktopRecordTabletBundleText.includes('getImageUploadDetail')
      || !desktopRecordTabletBundleText.includes('getDirectFieldworkPhotoDetail')
      || !desktopRecordTabletBundleText.includes('getPhotoDetail')
      || !desktopRecordTabletBundleText.includes('getMunsellCandidateSummaryLabel')
      || !desktopRecordTabletBundleText.includes('getSoilColorSampleSourceLabel')
      || !desktopRecordTabletBundleText.includes('parseSoilProfileColorSwatchRows')
      || !desktopRecordTabletBundleText.includes('getSoilProfilePhotoDetail')
      || !desktopRecordTabletBundleText.includes('getSoilProfileColorSwatchDetail')
      || !desktopRecordTabletBundleText.includes('getSoilProfileLayerMarkerDetail')
      || !desktopRecordTabletBundleText.includes('getDrawingDetail')
      || !desktopRecordTabletBundleText.includes('getPenMemoDetail')
      ...
      || !desktopRecordTabletBundleText.includes('sourceReviewCounts')
      || !desktopRecordTabletBundleText.includes('getSourceReviewCounts')
      || !desktopRecordTabletBundleText.includes('getSourceReviewSummaryLabel')
      || !desktopRecordTabletBundleText.includes('getKoreanFieldworkTabletSourceReviewSummaryLabel')
      || !desktopRecordTabletBundleText.includes('getSourceReviewCopyLabel')
      || !desktopRecordTabletBundleText.includes('makeBundleGroupCopyLines')
      || !desktopRecordTabletBundleText.includes('makeSourceRowCopyLines')
      || !desktopRecordTabletBundleText.includes('makeSourceReviewCopyLine')
      ...
      || !desktopRecordTabletBundleText.includes('KOREAN_FIELDWORK_TABLET_HANDOFF_SOURCE_REVIEWED_FINGERPRINT_FIELD')
      || !desktopRecordTabletBundleText.includes('makeBundleFingerprint')
      || !desktopRecordTabletBundleText.includes('makeSourceFingerprint')
      || !desktopRecordTabletBundleText.includes('hashFingerprintPayload')
      || !desktopRecordTabletBundleText.includes('getKoreanFieldworkTabletRecordBundleGroupSourcesForReview')
      || !desktopRecordTabletBundleText.includes('containsKoreanFieldworkTabletRecordBundleSource')
      || !desktopRecordTabletBundleText.includes('wouldKoreanFieldworkTabletRecordBundleBeReviewedAfterSourceReview')
      || !desktopRecordTabletBundleSpecText.includes('groups many tablet evidence records by kind for desktop handoff')
      || !desktopRecordTabletBundleSpecText.includes('\\ucc98\\ub9ac\\ub300\\uc0c1 8\\uac74')
      || !desktopRecordTabletBundleSpecText.includes('sourceReviewCounts')
      || !desktopRecordTabletBundleSpecText.includes('getKoreanFieldworkTabletSourceReviewSummaryLabel')
      || !desktopRecordTabletBundleSpecText.includes('marks tablet bundle sources that still need desktop review')
      || !desktopRecordTabletBundleSpecText.includes('formats tablet source copies as HWP-safe detail lines')
      || !desktopRecordTabletBundleSpecText.includes("not.toContain('\\t')")
      || !desktopRecordTabletBundleSpecText.includes('\\ucc98\\ub9ac: \\ubbf8\\ucc98\\ub9ac')
      || !desktopRecordTabletBundleSpecText.includes('tracks desktop review state for tablet bundle handoff processing')
      || !desktopRecordTabletBundleSpecText.includes('tracks desktop review state for individual tablet source rows')
      || !desktopRecordTabletBundleSpecText.includes('\\ucc98\\ub9ac: \\ucc98\\ub9ac\\ub428 2026-07-11')
      || !desktopRecordTabletBundleSpecText.includes('\\uc6d0\\uc790\\ub8cc \\ucc98\\ub9ac\\uc644\\ub8cc')
      || !desktopRecordTabletBundleSpecText.includes('orders tablet source rows by desktop processing priority')
      || !desktopRecordTabletBundleSpecText.includes('detects when reviewing a source row finishes the whole tablet bundle')
      || !desktopRecordTabletBundleSpecText.includes('carries tablet photo markings and sketch memos into desktop handoff source rows')
      || !desktopRecordTabletBundleSpecText.includes('soilProfileLayerMarkers')
      || !desktopRecordTabletBundleSpecText.includes('penMemoAutoTranscript')
      || !desktopRecordTabletBundleSpecText.includes('keeps tablet media captions and original file references together for desktop processing')
      || !desktopRecordTabletBundleSpecText.includes('IMG_0001.JPG')
      || !desktopRecordTabletBundleSpecText.includes('fieldworkImageUploadTarget')
      || !desktopRecordTabletBundleSpecText.includes('opens directly attached tablet record photos as desktop handoff sources')
      || !desktopRecordTabletBundleSpecText.includes('feature-direct-1.jpg')
      || !desktopRecordTabletBundleSpecText.includes('carries tablet find and sample spot points into desktop handoff source rows')
      || !desktopRecordTabletBundleSpecText.includes('bronze fragment')
      || !desktopRecordTabletBundleSpecText.includes('charcoal bag')
      || !desktopRecordTabletBundleSpecText.includes('LAB-2026-001')
      || !desktopRecordTabletBundleSpecText.includes('\\uc2dc\\ub8cc \\ubaa9\\uc801')
      || !desktopRecordTabletBundleSpecText.includes('carries tablet soil color sample points into desktop handoff source rows')
      || !desktopRecordTabletBundleSpecText.includes('file:///tablet/photos/profile-1.jpg')
      || !desktopRecordTabletBundleSpecText.includes('RGB 111/87/61 @ 20%/50%')
      || !desktopRecordTabletBundleSpecText.includes('marks reviewed tablet bundles stale when tablet source details change without count changes')
      || !desktopRecordTabletBundleSpecText.includes('\\uc6d0\\ubcf8/\\ubcf8\\ubb38 \\ub0b4\\uc6a9 \\ubcc0\\uacbd')
      || !desktopRecordContextPanelText.includes('makeKoreanFieldworkRecordTabletBundle')
      || !desktopRecordContextPanelText.includes('getKoreanFieldworkTabletRecordBundleGroupSourcesForReview')
      || !desktopRecordContextPanelText.includes('wouldKoreanFieldworkTabletRecordBundleBeReviewedAfterSourceReview')
      || !desktopRecordContextPanelText.includes('collectTabletRecordBundleReviewUpdateForSource')
      ...
      || !desktopRecordContextPanelText.includes('toggleTabletRecordBundleReviewed')
      || !desktopRecordContextPanelText.includes('toggleTabletRecordBundleSourceReviewed')
      || !desktopRecordContextPanelText.includes('createKoreanFieldworkTabletHandoffSourceReviewUpdate')
      || !desktopRecordContextPanelText.includes('getTabletRecordBundleSourceReviewLabel')
      || !desktopRecordContextPanelText.includes('getKoreanFieldworkTabletSourceReviewSummaryLabel')
      ...
      || !desktopRecordContextPanelTemplateText.includes('tabletBundle.sourceReviewCounts.openCount')
      || !desktopRecordContextPanelTemplateText.includes('getTabletRecordBundleSourceReviewLabel(tabletBundle)')
      || !desktopRecordContextPanelTemplateText.includes('tabletBundle.reviewState.label')
      || !desktopRecordContextPanelTemplateText.includes('source.reviewState.label')
      ...
      || !desktopRecordContextPanelTemplateText.includes('toggleTabletRecordBundleSourceReviewed(source)')
      || !desktopRecordContextPanelTemplateText.includes('getTabletRecordBundleGroupSources(group)')
      || !desktopRecordContextPanelStyleText.includes('korean-fieldwork-record-context-tablet-bundle-group')
      || !desktopRecordContextPanelStyleText.includes('korean-fieldwork-record-context-tablet-bundle-review-status')
      ...
      || !desktopRecordContextPanelStyleText.includes('korean-fieldwork-record-context-tablet-bundle-source-review')
      || !desktopRecordContextPanelStyleText.includes('korean-fieldwork-record-context-tablet-bundle-source-review-detail')
      || !desktopRecordContextPanelStyleText.includes('korean-fieldwork-record-context-tablet-bundle-source-open')
      || !desktopRecordContextPanelSpecText.includes('KOREAN_FIELDWORK_TABLET_HANDOFF_SOURCE_REVIEWED_AT_FIELD')
      || !desktopRecordContextPanelSpecText.includes('getTabletRecordBundleSourceReviewLabel(tabletBundle)')
      ...
      || !desktopRecordContextPanelSpecText.includes('marks the opened tablet bundle reviewed when its last source row is reviewed')) {
...
function validateReportHandoffPreSaveValidation() {
  ...
  if (!coreRecordContractText.includes('KOREAN_FIELDWORK_FEATURE_INVESTIGATION_CHECKLIST_LABELS')
      ...
      || !coreReportHandoffText.includes('fieldOnlyMissingCheck')
      || !coreReportHandoffText.includes('firstExposureRecord')
      || !coreReportHandoffSpecText.includes('investigation checklist steps into HWP copy blocks')
      || !coreReportHandoffSpecText.includes('fieldOnlyMissingCheck')
      || !coreReportHandoffSpecText.includes('firstExposureRecord')
      ...
      || !coreReportHandoffSpecText.includes("not.toContain('stratigraphicBoundary')")
      || !coreReportHandoffSpecText.includes("not.toContain('firstExposurePhoto')")
      ...
      || !desktopPriorityStripSpecText.includes('fieldOnlyMissingCheck')
      || !desktopPriorityStripSpecText.includes('firstExposureRecord')
      || !desktopPriorityStripSpecText.includes("not.toContain('stratigraphicBoundary')")
      || !desktopPriorityStripSpecText.includes("not.toContain('firstExposurePhoto')")
  ...
  if (!desktopPriorityStripText.includes('makeReportHandoffTabletBundles')
      ...
      || !desktopPriorityStripText.includes('copyReportHandoffTabletBundleGroup')
      || !desktopPriorityStripText.includes('copyReportHandoffTabletBundleSource')
      || !desktopPriorityStripText.includes('openReportHandoffTabletBundleSource')
      || !desktopPriorityStripText.includes('canOpenReportHandoffTabletBundleSource')
      || !desktopPriorityStripText.includes('toggleReportHandoffTabletBundleSourceReviewed')
      || !desktopPriorityStripText.includes('createKoreanFieldworkTabletHandoffSourceReviewUpdate')
      || !desktopPriorityStripText.includes('collectReportHandoffTabletSourceReviewUpdate')
      || !desktopPriorityStripText.includes('getReportHandoffTabletBundleGroupSources')
      || !desktopPriorityStripText.includes('copyAllReportHandoffTabletWork')
      || !desktopPriorityStripText.includes('getTabletWorkReportHandoffCopyText')
      || !desktopPriorityStripText.includes('makeTabletWorkReportHandoffSourceLines')
      || !desktopPriorityStripText.includes('getReportHandoffTabletBundleSourceReviewLabel')
      || !desktopPriorityStripText.includes('getKoreanFieldworkTabletSourceReviewSummaryLabel')
      || !desktopPriorityStripText.includes('needsTabletBundleDesktopProcessing')
      || !desktopPriorityStripText.includes('bundle.sourceReviewCounts.openCount > 0')
      || !desktopPriorityStripText.includes('keepFirstTabletWorkReportHandoffSource')
      || !desktopPriorityStripText.includes('filterTabletWorkReportHandoffIssueDetails')
      ...
      || !desktopPriorityStripText.includes('containsKoreanFieldworkTabletRecordBundleSource')
      || !desktopPriorityStripText.includes('wouldKoreanFieldworkTabletRecordBundleBeReviewedAfterSourceReview')
      ...
      || !desktopPriorityStripTemplateText.includes('tabletBundle.sourceReviewCounts.openCount')
      || !desktopPriorityStripTemplateText.includes('getReportHandoffTabletBundleSourceReviewLabel(tabletBundle)')
      || !desktopPriorityStripTemplateText.includes('tabletBundle.reviewState.detail')
      ...
      || !desktopPriorityStripTemplateText.includes('markAllReportHandoffTabletWorkReviewed($event)')
      ...
      || !desktopPriorityStripStyleText.includes('.korean-fieldwork-report-handoff-tablet-bundle-review-detail')
      || !desktopPriorityStripStyleText.includes('.korean-fieldwork-report-handoff-tablet-bundle-source')
      || !desktopPriorityStripStyleText.includes('.korean-fieldwork-report-handoff-tablet-bundle-source-review')
      || !desktopPriorityStripStyleText.includes('.korean-fieldwork-report-handoff-tablet-bundle-source-review-detail')
      ...
      || !desktopPriorityStripStyleText.includes('.tablet-review-all')
      || !desktopPriorityStripStyleText.includes('&.tablet-review')
      || !desktopPriorityStripText.includes('getKoreanFieldworkTabletRecordBundleGroupSourcesForReview')
      || !desktopPriorityStripSpecText.includes('featureTabletBundle')
      || !desktopPriorityStripSpecText.includes('keeps reviewed tablet bundles in the work filter while source rows remain open')
      || !desktopPriorityStripSpecText.includes('getReportHandoffTabletBundleSourceReviewLabel(tabletBundle)')
      ...
      || !desktopPriorityStripSpecText.includes('\\uc911\\ubcf5 \\uc6d0\\uc790\\ub8cc')
      || !desktopPriorityStripSpecText.includes('copies and opens tablet source rows from the report handoff preview')
      || !desktopPriorityStripSpecText.includes('toggleReportHandoffTabletBundleSourceReviewed')
  ...
  if (!desktopRecordWorkFilterText.includes('tabletProcessingDocumentIds')
      ...
      || !desktopPriorityStripText.includes('needsTabletBundleDesktopProcessing(bundle)')
      || !desktopPriorityStripSpecText.includes("tabletProcessingRecordIds.has('feature-done')")
...
function validateTabletInstallGuide() {
  ...
  if (!desktopWorkflowText.includes('Run Korean fieldwork parity check')
      || !desktopWorkflowText.includes('Run Korean fieldwork media contract check')
      || !desktopWorkflowText.includes('tools/korean-fieldwork-media-contract-check.js')
